...
const CookieEinstellungen = () => {
  useEffect(() => {
    window.location.replace("https://www.bp.com/de_de/germany/home/cookie-einstellungen.html");
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="text-center max-w-md mx-auto px-6">
        ...
        <a 
          href="https://www.bp.com/de_de/germany/home/cookie-einstellungen.html" 
